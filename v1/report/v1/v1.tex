...
\cite{agentbench2023}. Two phenomena central to multi-agent reasoning are not directly
...
\textbf{Qwen2.5-3B-Instruct} \cite{qwen2024} fine-tuned with LoRA
\cite{hu2022lora} on attention projections ($q,k,v,o$); $r{=}16$, $\alpha{=}32$,
dropout $0$, no bias. Training: GRPO \cite{deepseekr1} from HuggingFace
